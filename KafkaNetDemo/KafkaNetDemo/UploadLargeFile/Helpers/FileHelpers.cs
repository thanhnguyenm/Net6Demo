...
namespace UploadLargeFile.Helpers
{
    public static class FileHelpers
    {
        ...
        public static async Task<byte[]> ProcessStreamedFile(
            MultipartSection section, ContentDispositionHeaderValue contentDisposition, long sizeLimit)
        {
            try
            {
                using (var memoryStream = new MemoryStream())
            ...
            {
                throw new Exception("The upload failed. Please contact the Help Desk " + $" for support. Error: {ex.HResult}");
                // Log the exception
            }
        }
